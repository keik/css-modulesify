...
var globalCases = ['import-node-module'];
...
runTestCase('compose-from-shared')
// runTestCase('compose-local-node-module')
// runTestCase('compose-node-module')
// runTestCase('import-and-compose')
// runTestCase('import-node-module')
// runTestCase('multiple-js-files')
// runTestCase('simple')
